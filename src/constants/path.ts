export const PATH = {
  ...
  PROFILES: '/profiles',
  SCHEDULE: '/schedule',
  NEWS: '/tin-tuc/:slugParent/:slug',
  NEWS_PAGE: '/tin-tuc/:slugParent',
  PROFILES_DETAIL: '/profiles/:id',
  SUBMENU_3: ':menuSlug/:categorySlug/:subCategorySlug',
  ...
  MENTOR_EXAMS_DETAIL: '/mentor/exams/:id',
  MENTOR_EXAMS_QUESTION: '/mentor/exams/:id/questions',
