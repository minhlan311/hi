 ...
 */
const manifest = (
    self.__WB_MANIFEST.filter(({ url }) => !ignored.includes(url)) || []
).concat([
    {
 ...
 *
 * Caches at: runtime
 * api URL inside Array exp: ['https://dxnw2u9ac4.execute-api.ap-southeast-1.amazonaws.com',
      'https://preprodfileservice.petronas.com',]
 */
registerRoute(
