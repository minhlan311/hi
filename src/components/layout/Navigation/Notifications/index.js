...
//         }
//         if (notifi.targetModel === 'DOCUMENT') history.push('/documents/' + btoa(notifi.targetId))
//       }
//       return (
//         <Card
//           hoverable
//           className={`notification-item ${notifi.status === 'unread' ? 'see' : null}`}
//           onClick={handleSee}
//         >
//           <b>{notifi.title}</b>
//           <div>{notifi.body}</div>
...
//               <Button type='text' shape='circle' onClick={handleRealAll}>
...
//             </div>
//           ) : (
//             <Empty style={{ margin: '50px 0' }} description='Không có thông báo nào!' />
//           )}
//         </Card>
//       )
//     }
...
//       return (
//         <div className='notification-menu' style={isMobile || isTablet ? { width: '100%' } : null}>
//           <div className='d-space-c' style={{ padding: 10 }}>
...
//     }
//     const newArr = [
//       ...unReadNotifi.sort((a, b) => new Date(b.createdAt) - new Date(a.createdAt)),
//       ...readNotifi.sort((a, b) => new Date(b.createdAt) - new Date(a.createdAt))
//     ]
...
//         />
//       </Badge>
//       <Drawer closable={false} onClose={() => setOpenN(!openN)} open={openN} className='ntf-draw'>
...
//       className={
//         mentor && user.isMentor && (user.mentorStatus === 'APPROVED' || !user.mentorStatus) ? 'menu-ntf-m' : 'menu-ntf'
//       }
//       placement='bottom'
//     >
//       <div>
