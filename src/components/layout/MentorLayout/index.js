...
export default function MentorLayout({ children }) {
    ...
    const siderItems = [
        getItem(
            <Link to="/mentor">Danh sách câu hỏi</Link>,
            '/mentor',
            <ContainerOutlined />
        ),
        getItem(
            <Link to="/mentor/courses">Quản lý khóa học</Link>,
            '/mentor/courses',
            <DatabaseOutlined />
        ),
        getItem(
            <Link to="/mentor/documents">Quản lý tài liệu</Link>,
            '/mentor/documents',
            <SnippetsOutlined />
        ),
        getItem(
            <Link to="/mentor/exams">Quản lý đề thi thử</Link>,
            '/mentor/exams',
            <CarryOutOutlined />
        ),
    ]
                ...
                <Content
                    ...
                    style={
                        (isMobile || isTablet) && !collapsed
                            ? { position: 'absolute', marginTop: 63 }
                            : null
                    }
                >
                    {children}
