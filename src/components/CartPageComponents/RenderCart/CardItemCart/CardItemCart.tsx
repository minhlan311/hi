...
import { localAction as handleLocalAction } from '@/common'
    ...
    <div>
      <Row justify='space-between' className={css.card}>
        <Col span={24} md={4} className={css.image}>
          <ImageCustom width='100px' src={import.meta.env.VITE_FILE_ENDPOINT + '/' + data.coverMedia} />
        </Col>
