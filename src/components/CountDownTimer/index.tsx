...
const CountDownTimer = (props: Props) => {
  const { timeTillDate, timeInit = 1, timeFormat = 'HH:mm:ss' } = props
  const now = moment()
  ...
  return (
    <Space>
      <div className={css.flipClock}>{/* <CountdownTracker value={time.format('ss')} label={'giây'} /> */}</div>
