...
const classApi = {
  ...
  createClass(body: any) {
    return http.post<ClassState>(ENDPOINT.CLASS_PATH, body)
  },
  deleteClass(id: string) {
    return http.delete<SuccessResponse<ClassState>>(ENDPOINT.CLASS_PATH + id)
  },
  getOneClass(id: string) {
    return http.get<ClassState>(ENDPOINT.CLASS_PATH + id)
  },
  updateClass(body: any) {
    return http.put<ClassState>(ENDPOINT.CLASS_PATH + body.id, body)
  },
