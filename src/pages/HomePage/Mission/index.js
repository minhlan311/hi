                    ...
                    <Col span={24} md={12}>
                        <div className="ms-item">
                            ...
                            >
                                ...
                                <p>
                                    Trở thành hệ sinh thái đào tạo tiếng Anh
                                    giao tiếp & tạo môi trường chuyển hoá toàn
                                    diện cho nhiều học viên nhất tại Việt Nam
                                </p>
                            </Space>
                        </div>
                    </Col>
                    <Col span={24} md={12}>
                        <div className="ms-item">
                            ...
                            >
                                <h1>SỨ MỆNH</h1>
                                <p>
                                    Chuyển hóa người khác bằng việc thay đổi
                                    chính mình
                                </p>
                            </Space>
                        </div>
