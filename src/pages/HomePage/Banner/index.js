...
const Banner = () => {
    ...
    return (
        <>
            <div
                className={`${isMobile || isTablet ? null : 'mtz-container'}`}
                style={
                    isMobile || isTablet
                        ? { marginTop: 70 }
                        : { marginTop: 70, paddingTop: 25 }
                }
            >
                <Slider {...settingSlide}>
                    {banner &&
                        banner.map((item, id) => (
                            <div className="mtz-banner" key={id}>
                                <div
                                    className={
                                        isMobile || isTablet
                                            ? null
