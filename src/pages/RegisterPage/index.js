...
const RegisterPage = () => {
    ...
    const handleGoBackStep = () => {
        ...
        const previousFormValue = cloneDeep(formValues)
        const appendFormValues = Object.assign(
            previousFormValue,
            form.getFieldsValue()
        )
        ...
        return (
            ...
            >
                ...
                <h4 className="title-label">
                    Chọn vai trò của bạn để đăng ký phù hợp hơn nhé!
                </h4>
                {RolesDataSelection.map((item) => {
                    return (
                        <div
                            key={item.id}
                            className="mtz-role-card"
                            onClick={() => handleSelectRole(item.prefix)}
                        >
                            <div className="card-left">
                                <img
                                    src={item.imgIcon}
                                    alt="mentor role images"
                                    className="img-mentor-role"
                                />
    ...
    const renderGroupTitle = useMemo(() => {
        ...
        switch (steps) {
            case 1:
                title = 'Thông tin'
                subTitle =
                    'Hãy điền thông tin cá nhân cơ bản như họ tên, email, số điện thoại...'
                break
            case 2:
                if (roleSelected === 'mentor') {
                    title = 'Chứng chỉ'
                    subTitle =
                        'Điền thông tin chứng chỉ của bản thân, bạn là mentor đại học hay phổ thông?'
                } else {
                    title = 'Chọn trường'
                    subTitle =
                        'Điền thông tin trường đại học, ngành học của bản thân'
                }
                break
            case 3:
                title = 'Mật khẩu'
            ...
            steps === 1 && (
                <>
                    ...
                    <Form.Item
                        label={
                            roleSelected === 'mentor'
                                ? 'SĐT liên kết với tài khoản Zalo'
                                : 'SĐT'
                        }
                        name="phoneNumber"
                        rules={[
                ...
                >
                    ...
                    >
                        <h4 className="title" style={{ marginBottom: 25 }}>
                            <span className="text-blue">MentorZ</span> - Người
                            bạn đồng hành không thể thiếu trong việc{' '}
                            <span className="text-blue">học tập</span> của bạn!
                        </h4>
                        <h4 className="title-label">
                            Bắt đầu đăng ký để trải nghiệm MentorZ.
                        </h4>
                        <img
                            src={registerImg}
                ...
                {steps > 0 && (
                    <div className="mtz-register-form-container">
                        ...
                        <div className="form-body">
                            {renderRegisterFormByRoleSelection()}
                        </div>
                    </div>
                )}
            </div>
