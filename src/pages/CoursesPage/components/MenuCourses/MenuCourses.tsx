        ...
        {!isLoading ? (
          coursesData && Array.isArray(coursesData) && coursesData.length > 0 ? (
            coursesData.map((item) => (
              <div key={item._id} className={style.menuBox}>
                <Header>
                  <div className={style.boxContent}>
                    <div className={style.onbox}>
                      {/* Phần code để hiển thị thông tin của từng khóa học */}
                      <ImageCustom
                        onClick={() => {
                    ...
                    <div className={style.flexStar}>{/* Code để hiển thị sao đánh giá */}</div>
            ...
            <p>Không có khóa học liên quan nào !</p>
          )
        ) : (
          <LoadingCustom
            style={{
